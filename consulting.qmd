...
- Research institute, Australia, 2026. Reviewed an R package, [season](https://github.com/agbarnett/season), for seasonal analysis of health data. Implemented best practices in research software engineering (continuous integration, comprehensive testing, linting and formatting), modernised plotting to ggplot2, and added tidyverse integration. Published example-driven documentation and a package website, and delivered a prioritised roadmap for future maintenance. See work completed at during the review in the [closed issues](https://github.com/agbarnett/season/issues?q=is%3Aissue%20state%3Aclosed).
